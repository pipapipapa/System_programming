...
KEY_LEFT_CODE  equ 260
KEY_RIGHT_CODE equ 261
KEY_QUIT_CODE  equ 'q'

MAX_LIVES      equ 200
GAME_OVER_Y_LINE equ 1
...
BALL_COLOR_PAIR_RED     equ 1
BALL_COLOR_PAIR_BLUE    equ 2
BALL_COLOR_PAIR_GREEN   equ 3
BALL_COLOR_PAIR_YELLOW  equ 4
BALL_COLOR_PAIR_WHITE   equ 5
BALL_COLOR_PAIR_PURPLE  equ 6
SCREEN_BACKGROUND_PAIR  equ 7

MAX_BALLS           equ 3
BALL_TYPES          equ 6

PADDLE_MOVE_SPEED       equ 20
PADDLE_WIDTH_PERCENT    equ 10
MIN_PADDLE_WIDTH        equ 3

BONUS_NONE          equ 0
BONUS_EXTRA_LIFE    equ 1
BONUS_EXTRA_DAMAGE  equ 2
BONUS_PHASING       equ 3
BONUS_ACC_DX        equ 4
BONUS_ACC_DY        equ 5

INTERNAL_SCALE      equ 24
FRAME_TIME          equ 25              ; 1000//FPS
